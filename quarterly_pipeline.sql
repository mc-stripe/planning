...
(merchants.sales_funnel__activation_date IS NULL OR merchants.sales_funnel__activation_date >= '2017-03-27')
AND salesforcemerchants.opportunity_expected_go_live_date >= TIMESTAMP '2017-03-27' -- include things that may be going live this week
